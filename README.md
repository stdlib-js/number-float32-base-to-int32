...
```javascript
float32ToInt32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-to-int32@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-to-int32@v0.2.2-umd/browser.js"></script>
```
